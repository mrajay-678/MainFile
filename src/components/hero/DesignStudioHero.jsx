      ...
      <section className="hero__area-2">
        <div className="hero__inner-2">
          <div className="sec-title-wrapper">
            <h2 className="sec-title-3 bg-shape">0</h2>
            <h2 className="sec-title-3">1</h2>
          </div>
          <div className="hero__text-2">
            <p>We transform exponential ideas into ventures, products & services. From blueprint to design, development, brand and launch. We call this 0 to 1.</p>
            <div
              className="hero__button btn_wrapper"
              ref={btnWrapper}
            >
              <Link
                href="/service"
