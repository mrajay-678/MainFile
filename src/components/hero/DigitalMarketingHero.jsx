...
import Hero31 from "../../../public/assets/imgs/hero/3/nyuct-hompage-icons-01.png";
            ...
            <div className="col-xxl-12">
              <div className="hero__inner-3">
                ...
                <div className="hero__text-3">
                  <div className="hero__text-animation-outer">
                    <p
                      className="hero__text-animation"
                      ref={heroTextAnim}
                    >
                      The world is getting disrupted every day by technology, shape-shifting markets, evolving consumers, new business models, upstart-startups, bold new ideas, and accessible capital.
                      Business as usual has hence ceased to exist. Problems and opportunities today are increasingly out of syllabus. And hence your strategy as usual won’t work. Your business needs
                      to <b> re:Think, re:Design, re:Imagine. </b>
                    </p>
